...
def poisoned_pixel_LDP(norm_bound, noise_scale, nb_attackers, seed=1):
    ...
    # save test accuracy
    np.savetxt('../save/PixelAttack/TestAcc/LDP_{}_{}_clip{}_scale{}_attackers{}_seed{}.txt'.
               format(args.dataset, args.model, norm_bound, noise_scale, nb_attackers, s),
               testing_accuracy)

    np.savetxt('../save/PixelAttack/BackdoorAcc/LDP_{}_{}_clip{}_scale{}_attackers{}_seed{}.txt'.
               format(args.dataset, args.model, norm_bound, noise_scale, nb_attackers, s),
               backdoor_accuracy)
...
if __name__ == '__main__':
    ...
    for s in range(5):
        ...
        poisoned_pixel_LDP(norm_bound=2.2, noise_scale=0.1, nb_attackers=nb_attackers, seed=s)